...
| 학교 정보 | `elem_list` | `school_list` | 예 | 예 | `career/update_career.py` `sync-school-list` |
| 학교 정보 | `midd_list` | `school_list` | 예 | 예 | `career/update_career.py` `sync-school-list` |
| 학교 정보 | `high_list` | `school_list` | 예 | 예 | `career/update_career.py` `sync-school-list` |
| 학교 정보 | `univ_list` | `school_list` | 예 | 예 | `career/update_career.py` `sync-school-list` |
| 학교 정보 | `seet_list` | `school_list` | 예 | 예 | `career/update_career.py` `sync-school-list` |
